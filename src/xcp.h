...
#define CRM_GET_PAG_PROCESSOR_INFO_MAX_SEGMENTS CRM_BYTE(1)
...
#define CRO_GET_SEGMENT_INFO_SEGMENT_NUMBER CRO_BYTE(2)
#define CRO_GET_SEGMENT_INFO_SEGMENT_INFO CRO_BYTE(3)
#define CRO_GET_SEGMENT_INFO_MAPPING_INDEX CRO_BYTE(4)
#define CRM_GET_SEGMENT_INFO_LEN 8
#define CRM_GET_SEGMENT_INFO_BASIC_INFO CRM_DWORD(1)
